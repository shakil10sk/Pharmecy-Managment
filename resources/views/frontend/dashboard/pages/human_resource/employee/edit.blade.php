                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('employee.update',$employee->id) }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="last_name"
                                            ...
                                            id="last_name" placeholder="Last Name" value="{{ $employee->last_name }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="designation_id" id="select2" class="select2 form-control">
                                            ...
                                            <option value="{{ $value->id }}" {{ ($employee->designation_id == $value->id) ? "selected":"" }}>{{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="salary_type" id="select2" class="select2 form-control">
                                            ...
                                            <option value="salary" {{ ($employee->salary_type == "salary") ? "selected":"" }}>Salary</option>
                                        </select>
                                    </div>
                                    @error('salary_type')
                                    <div class="alert text-danger m-b-0">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" class="form-control" name="salary_value" id="salary_value"
                                            placeholder="Salary Rate " value="{{$employee->salary_value }}">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input class="form-control input-mask-trigger text-left valid_number" id="email"
                                            ...
                                            data-inputmask="'alias': 'decimal', 'groupSeparator': '', 'autoGroup': true"
                                            im-insert="true" value="{{ $employee->email }}">
                                    </div>
                                    @error('email')
                                    <div class="alert text-danger m-b-0">
                                        <span>{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input class="form-control" id="blood" type="text" name="blood"
                                            placeholder="blood Group" class="form-control" value="{{ $employee->blood }}" />
                                    </div>
                                    @error('blood')
                                    <div class="alert text-danger m-b-0">
                                        <span>{{ $message }}</span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <textarea name="address2" id="address" class="form-control">{{ $employee->address2 }}</textarea>
                                    </div>
                                    @error('address2')
                                    <div class="alert text-danger m-b-0">
                                        <span>{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="country" class="form-control" id="country"
                                            placeholder="Country" value="{{ $employee->country }}">
                                    </div>
                                    @error('country')
                                    <div class="alert text-danger m-b-0">
                                        <span>{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <label class="radio-inline my-2">
                                            <input type="radio" name="status" value="active" {{ ($employee->status == "active") ? "checked":"" }} id="status">
                                            Active
                                        </label>
                                        <label class="radio-inline my-2">
                                            <input type="radio" name="status" value="inactive" {{ ($employee->status == "inactive") ? "checked":"" }} id="status">
                                            Inactive
                                        </label>
                                    </div>
                                </div>
