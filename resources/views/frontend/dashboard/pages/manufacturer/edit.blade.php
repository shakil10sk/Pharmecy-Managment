            ...
            <div class="col-md-12 col-lg-12" >
                <div class=" panel panel-default  " style="padding:30px;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('manufacturer.update',$manufacturer->id) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="manufacturer_name" class="form-control"
                                            id="manufacturer_name" placeholder="Manufacturer Name" value="{{ $manufacturer->manufacturer_name }}">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="manufacturer_mobile"
                                            ...
                                            id="manufacturer_mobile" placeholder="Mobile No" value="{{ $manufacturer->manufacturer_mobile }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="email" class="form-control input-mask-trigger"
                                            name="manufacturer_email" id="email" data-inputmask="'alias': 'email'"
                                            im-insert="true" placeholder="Email" value="{{ $manufacturer->manufacturer_email }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" class="form-control" name="email_address" id="email_address"
                                            placeholder="Email Address" value="{{ $manufacturer->email_address }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input class="form-control input-mask-trigger text-left valid_number" id="phone"
                                            ...
                                            data-inputmask="'alias': 'decimal', 'groupSeparator': '', 'autoGroup': true"
                                            im-insert="true" value="{{ $manufacturer->phone }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input class="form-control" id="contact" type="text" name="contact"
                                            placeholder="Contact" value="{{ $manufacturer->contact }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <textarea name="address" id="manufacturer_address" class="form-control"
                                            placeholder="Address 1">{{ $manufacturer->address }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <textarea name="address2" id="address2" class="form-control"
                                            placeholder="Address 2">{{ $manufacturer->address2 }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="state" class="form-control" id="state"
                                            placeholder="State" value="{{ $manufacturer->state }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input name="country" type="text" class="form-control " placeholder="Country"
                                            value="{{ $manufacturer->country }}" id="country">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input name="previous_balance" type="number"
                                            ...
                                            data-inputmask="'alias': 'decimal', 'groupSeparator': '', 'autoGroup': true"
                                            im-insert="true" value="{{ $manufacturer->previous_balance }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
