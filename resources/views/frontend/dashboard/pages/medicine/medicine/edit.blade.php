            ...
            <div class="col-md-12 col-lg-12">
                <div class=" panel panel-default  " style="padding:30px;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('medicine.update',$medicine->id) }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="medicine_name" class="form-control" id="medicine_name"
                                            placeholder="Medicine Name" value="{{ $medicine->medicine_name }}">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="barcode_id"
                                            ...
                                            id="barcode_id" placeholder="Barcode No" value="{{ $medicine->barcode_id }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="strength" class="form-control input-mask-trigger" name="strength"
                                            ...
                                            placeholder="Strength" value="{{ $medicine->strength }}">
                                        @error('strength')
                                        <div class="alert text-danger m-b-0">
                                            <span>{{ $message }}</span>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" class="form-control" name="generic_name" id="generic_name"
                                            placeholder="Generic Name" value="{{ $medicine->generic_name }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="box_size" id="" class="select2 form-control">
                                            ...
                                            <option value="{{ $value->id }}" {{  ($medicine->box_size == $value->id) ? "selected" : "" }}>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="unit_id" id="" class="select2 form-control">
                                            ...
                                            @if($value->status == 1)
                                            <option value="{{ $value->id }}" {{ ($medicine->unit_id == $value->id) ? "selected" : "" }} > {{ $value->unit }}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input class="form-control" id="product_location" type="text"
                                            name="product_location" placeholder="Shelf" value="{{ $medicine->product_location }}">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="product_details" class="form-control"
                                            id="product_details" placeholder="Medicine Details" value="{{ $medicine->product_details }}">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="category_id" id="" class="select2 form-control">
                                            ...
                                            @if($value->status == 1)
                                            <option value="{{ $value->id }}" {{ ($medicine->category_id == $value->id) ? "selected" : "" }}>{{ $value->name }}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" class="form-control" name="price" id="price"
                                            placeholder="Price" value="{{ $medicine->price }}">
                                    </div>
                                    @error('price')
                                    <div class="alert text-danger m-b-0">
                                        <span>{{ $message }}</span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="type_id" id="type_id" class="select2 form-control">
                                            ...
                                            @if($value->status == 1)
                                            <option value="{{ $value->id }}" {{ ($medicine->type_id == $value->id) ? "selected" : "" }}>{{ $value->type }}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <label for="image" class="col-md-2 text-right col-form-label"> Photo </label>
                                <div class="col-md-4">
                                    <div class="row m-0 p-0">
                                        ...
                                        <div class="col-md-3">
                                            <img src="{{ asset('images/medicine/'.$medicine->image) }}" alt="" id="imgshow" style="width:70px ; height:70px">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <select name="manufacturer_id" id="" class="select2 form-control">
                                            ...
                                            <option value="{{ $value->id }}" {{ ($medicine->manufacturer_id == $value->id) ? "selected" : "" }}>{{ $value->manufacturer_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="manufacturer_price" class="form-control"
                                            ...
                                            value="{{ $medicine->manufacturer_price }}">
                                    </div>
