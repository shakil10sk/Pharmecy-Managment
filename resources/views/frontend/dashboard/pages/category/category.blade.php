                    ...
                    @foreach($category as $key => $value)
                        <tr class="gradeX">
                            ...
                            <td class="actions">
                                ...
                                <a href="/category/{{$value->id}}/edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                <a href="/category/{{$value->id}}/delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                            </td>
