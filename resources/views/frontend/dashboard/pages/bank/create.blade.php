                        ...
                        <form action="{{ route('bank.store') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="bank_name" class="form-control"
                                            id="bank_name" placeholder="Bank Name" value="">
                                        <input type="hidden" name="old_name" value="{{ old('bank_name') }}">
                                    </div>
                                    @error('bank_name')
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="account_name"
                                            ...
                                            id="account_name" placeholder="Account Name" value="{{ old('account_name') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="number" class="form-control input-mask-trigger"
                                            ...
                                            im-insert="true" placeholder="Account Number" value="">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @enderror
                                    <br>
                                            <img src="{{ asset('images/bank.jpg') }}" alt="" id="imgshow" style="width: 70px ; height: 60px ;">
                                </div>
                                <label for="active" class="col-md-2 text-right col-form-label">Status :</label>
                                <div class="col-md-4">
                                    <div class="">
                                        <input class="" id="active" type="radio" name="status"
                                            placeholder="Contact" value="active" checked> <label for="active">Active</label>
                                        <input class="" id="inactive" type="radio" name="status"
                                            placeholder="Contact" value="inactive"> <label for="inactive">Inactive</label>
                                    </div>
                                    @error('status')
                                        <div class="alert text-danger m-b-0">
                                            <span>{{ $message }}</span>
