                    ...
                    <div class="card-header py-2" >
                        <div class="row m-b-10">
                            <div class="text-left col-md-6 col-lg-6 col-sm-6">
                                <h4 class="fs-17 font-weight-600 mb-0 pt-2 pb-2">Add Customer</h4>
                            </div>
                            <div class="text-right col-md-6 col-lg-6 col-sm-6">
                                <a href="{{ route('customer.index') }}"
                                    class="btn btn-success btn-sm mr-1"><i
                                        class="fa fa-align-justify m-r-10"></i>Customer List</a>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <input type="hidden" name="old_name" value="{{ old('customer_name') }}">
                                    </div>
                                    @error('customer_name')
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="text" name="customer_mobile"
                                            ...
                                            id="customer_mobile" placeholder="Mobile No" value="{{ old('customer_mobile') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        <input type="email" class="form-control input-mask-trigger"
                                            ...
                                            im-insert="true" placeholder="Email" value="">
                                    </div>
                                </div>
